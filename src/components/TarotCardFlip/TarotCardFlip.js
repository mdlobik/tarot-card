            ...
            if (allFlipped && !hasGeneratedReading) {
                ...
                try {
                    ...
                    if (response.data?.reading) {
                        ...
                        // Check if the reading was generated by an LLM (either Gemini or Groq)
                        if (response.data?.source === 'gemini' || response.data?.source === 'groq') {
                            console.log(`LLM-generated reading received from ${response.data.source}`);
                            setIsLLMGenerated(true);
                        } else {
                            console.log('Local reading received - LLM APIs may not be configured correctly');
                            setIsLLMGenerated(false);
                            // Set an error message to inform the user that the LLM is not available
                            setError(
                                "Your reading was generated locally because neither Gemini nor Groq APIs are available. " +
                                "To get AI-generated readings, please ensure your API keys are correctly set up."
                            );
                        }
                        ...
                        // Set an error message to inform the user that the LLM is not available
                        setError(
                            "Your reading was generated locally because the Gemini API is not available. " +
                            "To get AI-generated readings, please ensure your Gemini API key is correctly set up in the .env file."
                        );
                    }
                } catch (error) {
                    ...
                    let errorMessage =
                        "Your reading was generated locally because neither Gemini nor Groq APIs are available. " +
                        "To get AI-generated readings, please ensure your API keys are correctly set up in the .env file.";
